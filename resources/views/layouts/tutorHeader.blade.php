...
<head>
    ...
    {{-- <meta name="canonical" href="https://coachingdetail.com"> --}}
    <link rel="canonical" href="https://coachingdetail.com">
    <meta name="description" content="{{ $tutor->about }}" />
    {{-- OGP --}}
    <meta property="og:title" content="{{ $tutor->name }}" />
    <meta property="og:url" content="{{ url("tutor/$tutor->slug") }}" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="{{ $tutor->about }}" />
    <meta property="og:image" content="{{ url('storage') . '/' . $tutor->logo }}" />

    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="{{ $tutor->name }}" />
    <meta name="twitter:description" content="{{ $tutor->about }}" />
    <meta name="twitter:url" content="https://www.coachingdetail.com" />
    <meta name="twitter:image" content="{{ url('storage') . '/' . $tutor->logo }}" />
    ...
    <script type="application/ld+json">
    {
      ...
      "url": "{{ url("tutor/$tutor->slug") }}",
      "logo": "{{ url('storage') . '/' . $tutor->logo }}",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "{{$tutor->landmark}},{{$tutor->address}}",
        "addressLocality": "{{$tutor->district}}",
        "postalCode": "{{$tutor->pincode}}",
        "addressCountry": "India"
      },
      "telephone": "{{$tutor->phone}}",
      "email": "{{$tutor->email}}",
      "image": "{{ url('storage') . '/' . $tutor->logo }}",
      "priceRange": "$$$",
      "review": {
        "@type": "Review",
        "reviewRating": {
        ...
        "datePublished": "{{ date('Y-m-d',strtotime($tutor->created_at))}}",
        "reviewBody": "Review of the tutor"
      }
    }
    </script>
...
<body>
    <header class="h" style="z-index:1000;">
        <div class="h__c">
            <ul class="h__c-ul">
                <!-- <li class="h__c-ul-li">
                    <a href="http://etweet.coachingdetail.com">
                        {{-- <img src="https://c.tenor.com/x8buEnCiZ4MAAAAC/new-blinking.gif" alt="New"> --}}
                        <p>
                            Education Tweet
                        </p>
                    </a>
