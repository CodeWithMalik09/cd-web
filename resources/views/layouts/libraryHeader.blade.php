...
<head>
    ...
    <meta name="description" content="{{ $library->about }}" />
    {{-- OGP --}}
    <meta property="og:title" content="{{ $library->name }}" />
    <meta property="og:url" content="{{ url("coaching/$library->slug") }}" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="{{ $library->about }}" />
    <meta property="og:image" content="{{ url('storage') . '/' . $library->logo }}" />

    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="{{ $library->name }}" />
    <meta name="twitter:description" content="{{ $library->about }}" />
    <meta name="twitter:url" content="https://www.coachingdetail.com" />
    <meta name="twitter:image" content="{{ url('storage') . '/' . $library->logo }}" />
    ...
    <script type="application/ld+json">
    {
      ...
      "url": "{{ url("library/$library->slug") }}",
      "logo": "{{ url('storage') . '/' . $library->logo }}",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "{{$library->landmark}},{{$library->address}}",
        "addressLocality": "{{$library->district}}",
        "postalCode": "{{$library->pincode}}",
        "addressCountry": "India"
      },
      "telephone": "{{$library->phone}}",
      "email": "{{$library->email}}",
      "image": "{{ url('storage') . '/' . $library->logo }}",
      "priceRange": "$$$",
      "review": {
        "@type": "Review",
        "reviewRating": {
        ...
        "datePublished": "{{ date('Y-m-d',strtotime($library->created_at))}}",
        "reviewBody": "Review of the library"
      }
    }
    </script>
