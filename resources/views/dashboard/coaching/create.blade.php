...
@section('content')
    ...
    <div class="crcoaching">
        <div class="crcoaching__c">
            <form action="{{ url('dashboard/insertcoaching') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="crcoaching__c-l">
                      ...
                      <div class="fr">
                        ...
                        <script>
                            ...
                            function updateLocalityDropdown(selectedCity) {
                                ...
                                var filteredLocalities = {!! json_encode($localities) !!}.filter(function(locality) {
                    ...
                    {{-- <div class="fr">
                            <div class="fi">
                                ...
                                <select name="courses[]" multiple="multiple" id="courses" class="select-multiple">
                                    @foreach ($courses as $course)
                                        <option value="{{$course->id}}">{{$course->name}}</option>
                                    @endforeach
                                </select>
           ...
           <input type="text" name="landline_number" id="landline">
                       ...
                       @include('dashboard.coaching.working_hours')
                        @include('dashboard.coaching.result')
                        @include('dashboard.coaching.results')
                        @include('dashboard.coaching.faculty')
                        @include('dashboard.coaching.feestructure')

                    </div>
                    {{-- <button type="submit">Add Coaching</button> --}}
                </div>
