...
<body>
   ...
   <div class="rff">
    ...
    <table id="myTable">
        ...
        <tbody id="table-body">
            @if (!isset($working_hours) || $working_hours->count() == 0)
            <tr>
                <center>
                <td>
            ...
            <tr>
                <center>
                <td>
                   <input type="text" name="week_days[]" placeholder="e.g. Monday-to-Friday" style="height:30px;border-radius:5px;outline:none;border:none;text-align:center" value="{{$working_hour->weekdays}}">
                </td>
                <td>
                    <input type="text" name="time_from[]" id="timepicker" placeholder="Select Time" style="height:30px;border-radius:5px;outline:none;border:none;text-align:center" value="{{$working_hour->from}}">
                </td>
                <td><input type="text" name="time_to[]" id="timepicker" placeholder="Select Time"style="height:30px;border-radius:5px;outline:none;border:none;text-align:center" value="{{$working_hour->to}}">
