                     ...
                     {{--   <div class="fr">
                        ...
                        <div class="fr">
                            <div class="fi">
                                ...
                                <input type="text" name="landline_number" value="{{ $coaching->landline_number }}"
                                    id="landline">
                            </div>
                            <div class="fi">
                        ...
                        <div class="fr">
                            ...
                            {{-- <div class="fi">
                                ...
                                <input type="number" name="batch_strength" value="{{ $coaching->batch_strength }}"
                                    id="strength">
                            </div> --}}
                        </div>
                        <div class="fr">
                        ...
                        <div class="fr">
                            <div class="fi">
                                ...
                                <input type="number" name="total_area" value="{{ $coaching->total_area }}"
                                    id="area">
                            </div>
                            <div class="fi">
...
{{--
                        ...
                        @include('dashboard.coaching.appliedresults', [
                            'appliedresults' => $coaching->appliedresults->where('data_type','result'),
                        ])
                        --}}
                        @include('dashboard.coaching.coursecategories', ['coursecategories' => $coaching->coursecategories])
                        @include('dashboard.coaching.appliedworkinghours', ['appliedworkinghours' => $coaching->appliedworkinghours])
                     @include('dashboard.coaching.appliedachievements', ['appliedachievements' => $coaching->appliedachievements])
                     @include('dashboard.coaching.appliedresults', ['appliedresults' => $coaching->appliedresults])
                        @include('dashboard.coaching.appliedfaculties', ['appliedfaculties' => $coaching->appliedfaculties])
                        @include('dashboard.coaching.appliedfeestructures', ['appliedfeestructures' => $coaching->appliedfeeStructures])
                    </div>
                </div>

                <div class="crcoaching__c-r">
                    <div class="btn__c">
                   {{--     <button type="submit" class="btn__c-btn">Update Applied Coaching</button>--}}
                    </div>
                    ...
                    <div class="gc">
                        @if ($coaching->galleries->count() > 0)
                            @foreach ($coaching->galleries as $img)
                                <div class="img__c"> {{--
                                    <a href="{{ url("dashboard/delete-New-coaching-gallery-image/$img->id") }}">--}}
                                        <div class="remove">
                                            <span>X</span>
                                        </div>
                                    </a>
