                ...
                @php
                    if($coaching->latitude && $coaching->latitude != "N/A"  && $coaching->latitude != "" ){
                        $contentString = 
                            ...
                            '<h1 id="firstHeading" class="firstHeading">'.$coaching->name.'</h1>'.
                            '<div id="bodyContent">'.
                            "<ul>".
                                "<li>Ratings: 4.2</li>".
                            ...
                            echo "[{ lat: parseFloat(".$coaching->latitude."), lng: parseFloat(".$coaching->longitude.") },'".$coaching->name."','".$coaching->logo."','".$contentString."'],";
                    }
                @endphp
            ]
