...
<body>
   ...
   <div class="rff">
    <div class="rff__c">
        <h5 class="accordian">Working Hours</h5>
    ...
    <table id="myTable">
        ...
        <tbody id="table-body">
            <?php if(!isset($working_hours) || $working_hours->count() == 0): ?>
            <tr>
                <center>
                <td>
            ...
            <tr>
                <center>
                <td>
                   <input type="text" name="week_days[]" placeholder="e.g. Monday-to-Friday" style="height:30px;border-radius:5px;outline:none;border:none;text-align:center" value="<?php echo e($working_hour->weekdays); ?>">
                </td>
                <td>
                    <input type="text" name="time_from[]" id="timepicker" placeholder="Select Time" style="height:30px;border-radius:5px;outline:none;border:none;text-align:center" value="<?php echo e($working_hour->from); ?>">
                </td>
                <td><input type="text" name="time_to[]" id="timepicker" placeholder="Select Time"style="height:30px;border-radius:5px;outline:none;border:none;text-align:center" value="<?php echo e($working_hour->to); ?>">
...
<?php /**PATH C:\Users\asus\Downloads\cd\resources\views/dashboard/coaching/working_hours.blade.php ENDPATH**/ ?>