        ...
        <div class="h__b-c-n">
            ...
            <div class="h__b-c-s">
                ...
                <div class="btn mapsearch" id="mapsearch">
                    <a id="mapsearch_btn" href="<?php echo e(url('mapsearch') . '/hello/world'); ?>">
                        MAP SEARCH
                    </a>
                </div>
            </div>
...
<script>
    ...
    $('#search-form').click((e) => {
        ...
        if ($('#course').val() == "" && ($("#type").val().toUpperCase() != "BY NAME" && $("#type").val().toUpperCase() != "LIBRARY")) {
            ...
            window.open(
                `<?php echo e(url('tutors')); ?>/${$('#course').val().toLowerCase()}/${$('#city').val().toLowerCase()}`,
                '_self');
        } else if ($("#type").val().toUpperCase() === "LIBRARY") {
            window.open(
                `<?php echo e(url('libraries')); ?>/${$('#city').val().toLowerCase()}`,
                '_self');
        } else if ($("#type").val().toUpperCase() === "BY NAME") {
            window.open(
                `<?php echo e(url('search-by-name-city')); ?>/${$('#searchtext').val()}/${$('#city').val()}`,
                '_self');
        } else {
            window.open(
                `<?php echo e(url('homesearch')); ?>/${$('#type').val().toLowerCase().replace(" ",'-')}/${$('#course').val().toLowerCase()}/${$('#city').val().toLowerCase()}`,
                '_self');
        }
    })
    ...
    $('#mapsearch_btn').click((e) => {
        ...
        if ($('#course').val() == "") {
            ...
            window.open(
                `<?php echo e(url('mapsearch')); ?>/${$('#type').val().toLowerCase().replace(" ",'-')}/${$('#course').val().toLowerCase()}/${$('#city').val().toLowerCase()}`,
                '_self');
        }
    })
            ...
            if($("#type").val().toUpperCase() == "BY NAME"){
                ...
                $.ajax({
                   headers: {
                    ...
                    url: "<?php echo e(url('getcoachingbyname')); ?>", 
                    method: "POST",
                    data: {
                            "city": cityId
                        },
...
</script><?php /**PATH C:\Users\asus\Downloads\cd\resources\views/components/homeheaderbottom.blade.php ENDPATH**/ ?>