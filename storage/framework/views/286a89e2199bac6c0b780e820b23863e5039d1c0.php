                ...
                <form action="<?php echo e(url('login')); ?>" method="POST">
                    ...
                    <div class="fi">
                        ...
                        <div class="fi__forget">
                            ...
                            <a class="forget" href="<?php echo e(url('forgetpassword')); ?>">Forgot?</a>
                        </div>
                    </div>
                    <p class="policy">By continuing, you agree to Coaching Detail Terms of Use and <a href="<?php echo e(url('privacy-policy')); ?>">Privacy Policy</a>.</p>
                    <button type="submit" class="btnsub">Login</button>
                    <a href="<?php echo e(url('login')); ?>"><p>New User? Create Account</p></a>
                </form>
            </div>
        </div>
    </div>
...
</script><?php /**PATH C:\Users\asus\Downloads\cd\resources\views/components/homeloginpopup.blade.php ENDPATH**/ ?>